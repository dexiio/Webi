...
public class DOMDocument
    ...
    public boolean loadHTML(Env env, String source) {
        ...
        try {
            ...
            /**
             * XXX: _delegate.setDoctype(new QDocumentType("html", "-//W3C//DTD HTML 4.0 Transitional//EN",
    ...
    private void saveToStream(DOMNode delegate, WriteStream os, boolean isHTML)
        ...
        if (delegate._delegate instanceof Document) {
            /*
             * Print the XML Declaration ( the <?xml thing ) only for Documents, as they don't make sense when just
             * printing nodes.
             */

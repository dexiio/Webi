...
public class QuercusContext {
    ...
    /*
     * private ClassDef _stdClassDef; private QuercusClass _stdClass;
     */
    ...
    private ConcurrentHashMap<Env, Env> _activeEnvSet = new ConcurrentHashMap<Env, Env>();
    ...
    /*
     * Returns the mysql version to report to to PHP applications. It is user set-able to allow cloaking of the
     * underlying mysql JDBC driver version for application compatibility.
     */
    ...
    /*
     * Sets the mysql version to report to applications. This cloaks the underlying JDBC driver version, so that when an
     * application asks for the mysql version, this version string is returned instead.
     */
     ...
     */
    /*
     * public void addModule(QuercusModule module) throws ConfigException { try {
     * introspectPhpModuleClass(module.getClass()); } catch (Exception e) { throw ConfigException.create(e); } }
     */
    /**
     * Adds a java class
     */
    ...
    public void addImplClass(String name, Class type)
        ...
        /*
         * try { introspectJavaImplClass(name, type, null); } catch (Exception e) { throw ConfigException.create(e); }
         */
    }
     ...
     */
    /*
     * public DefinitionState getDefinitionCache(DefinitionKey key) { SoftReference<DefinitionState> defStateRef =
     * _defCache.get(key);
     *
     * if (defStateRef != null) { DefinitionState defState = defStateRef.get();
     *
     * if (defState != null) { _defCacheHitCount++;
     *
     ...
     */
    /*
     * public void putDefinitionCache(DefinitionKey key, DefinitionState defState) { _defCache.put(key, new
     * SoftReference<DefinitionState>(defState.copy())); }
     */
    /**
     ...
     */
    /*
     * public StringValue intern(String name) { StringValue value = _internMap.get(name);
     *
     * if (value != null) return value;
     *
     * synchronized (_internMap) { value = _internMap.get(name);
     *
     * if (value != null) return value;
     *
     * if (value == null) { name = name.intern();
     *
     * value = new StringBuilderValue(name); _internMap.put(name, value); }
     *
     * return value; } }
     */
    /**
    ...
    static {
         ...
         * String includePath;
         *
         * if (Path.isWindows()) includePath = "." + FileModule.PATH_SEPARATOR + "C:\\php5\\pear"; else includePath =
         * "." + FileModule.PATH_SEPARATOR + "/usr/share/php" + FileModule.PATH_SEPARATOR + "/usr/share/pear";
         *
